...
users = pd.read_csv('D:\Online Books\Dataset\BX-CSV-Dump\BX-Users.csv',sep=';', encoding='latin-1') #278858 users
items = pd.read_csv('D:\Online Books\Dataset\BX-CSV-Dump\BX-Books.csv',sep=';',error_bad_lines=False, encoding='latin-1') #271360 items
ratings = pd.read_csv('D:\Online Books\Dataset\BX-CSV-Dump\BX-Book-Ratings.csv',sep=';', encoding='latin-1') #105283 users/ 340556 items. More items in ratings than in items.
