...
class Books():
    ...
    def __init__(self):
        self.books = pd.read_csv(r'C:\Users\Hp\Desktop\books_url.csv',delimiter=',')
        self.users = pd.read_csv(r'C:\Users\Hp\Desktop\Users.csv',delimiter=',')
        self.ratings = pd.read_csv(r'C:\Users\Hp\Desktop\ratings(2).csv',delimiter=',')
